...
(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/all.js#xfbml=1&appId=560373057369233";
...
(function() {
  jQuery(function() {
    $(".proposal-btn").hide();
    return $(".proposal").hover(function() {
      return $(this).find(".proposal-btn").fadeIn(40);
    }, function() {
      return $(this).find(".proposal-btn").fadeOut(10);
    });
  });
